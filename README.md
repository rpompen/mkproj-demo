...
If you move the jar file, keep in mind that all paths are relative to the location from where you run, e.g. if the code opening `data/items.edn` is still there, you'll get an error.
